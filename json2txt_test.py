...
testtxt_file = '2007_test.txt'
ftesttxt = open(testtxt_file, 'w')
...
#json_filename = 'D:\\final_yolo\Demo/Annotations/'
json_filename = 'scaphoid/VOC2007/Annotations/'
demo_filenametxt = 'scaphoid/VOC2007/ImageSets/Main/test.txt'
demo_json2txt = 'scaphoid/VOC2007/Annotations'

f = open('scaphoid/VOC2007/ImageSets/Main/test.txt')
